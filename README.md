...
- 精选强化题库包含 7 道题：主旨题、细节题、推理题、词义题、结构题、主题题等
- 人工样例扩展题库包含 6 道题：主旨题、细节题、推理题、词义题、结构题、启示题等
- 按题库类型筛选：精选强化、基础大题库、人工样例、自定义导入
- 按难度筛选文章
- 按主题筛选文章
- 按标题、主题、source 搜索文章
- 随机抽取文章
- 首页分页加载，避免一次渲染大量卡片导致手机卡顿
- 点击开始后自动计时
- 提交后自动停止计时
- 自动批改选择题
- 自动计算：
...
`js/curated-passages.js` 会构建 500 篇强化练习文章。
...
- 每篇 7 道题
- 题型更接近正式阅读理解
- 包含主旨题、细节题、推理题、词义题、篇章结构题、主题题
- 适合优先练习

## 200 篇人工样例扩展题库说明

`js/manual-passages.js` 会构建 200 篇人工样例风格文章。

人工样例扩展题库的特点：

- 文章更像短篇阅读理解样例
- 每篇 6 道题
- 覆盖日常生活、学习、旅行、商业、科技、社区、文化、科学等主题
- 适合快速练习和检查功能
